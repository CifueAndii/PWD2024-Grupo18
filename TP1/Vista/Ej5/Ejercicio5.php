...
<div id="ejercicio">
    <form id="ejercicioFormulario" name="form" method="get" action="mostrarSaludoEstudioSexo.php">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="direccion" id="direccion" class="inputForm" pattern="([0-9a-zñüáéíóúA-ZÑÜÁÉÍÓÚ']+)(\s+([0-9a-zñüáéíóúA-ZÑÜÁÉÍÓÚ']+))*" required></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select name="sexo" id="sexo" class="formulario_input form-select" required>
