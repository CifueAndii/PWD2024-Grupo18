...
<div class="row justify-content-center">
	<div class="col-md-12">
		<form class="formulario needs-validation row g-3" id="formulario" method="post" action="Accion/AccionForm3.php" enctype="multipart/form-data">
			...
			<!--IMAGEN-->
        	<div class="formulario_grupo col-5 mb-5">
